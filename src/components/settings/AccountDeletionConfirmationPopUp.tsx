...
function AccountDeletionConfirmationPopUp({closeOverlayHandler}:{closeOverlayHandler:()=>void}) {
  return (
    <OverlayModal title={"Confirmation"} closeOverlayHandler={closeOverlayHandler}>
...
export default AccountDeletionConfirmationPopUp
